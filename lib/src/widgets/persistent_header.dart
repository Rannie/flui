...
class FLSliverPersistentHeaderWidgetBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FLSliverPersistentHeaderWidget(
      ...
      overlapsContent: overlapsContent,
      headerTop: headerTop,
      header: FLPersistentHeaderLayoutBuilder(builder: (context, constraints) => builder(context, constraints.state)),
    );
  }
}
...
class _FLPersistentHeaderLayoutBuilderElement extends RenderObjectElement {
  ...
  @override
  void removeChildRenderObject(RenderObject child) {
    final FLRenderPersistentHeaderLayoutBuilder renderObject = this.renderObject;
